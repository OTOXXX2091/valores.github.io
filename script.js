...
let questions = [ 
	...
	{ 
		...
		answer: "Trabajo en equipo", 
	}, 

	{ 
		prompt: `Cual es el siguiente valor:
		         Somos personas honestas y transparentes,
	...
	{ 
		prompt: `Cual es el siguiente valor:Trabajamos en un marco de relaciones interpersonales sanas
		          basadas en la igualdad, 
				  la tolerancia a las diferencias y con una comunicación asertiva.`, 
		options: [ 
			"Integridad", 
			"Trabajo  en equipo", 
			"Respeto", 
...
function questionClick() { 
	if ( 
		...
		timerEl.textContent = time; 
		feedbackEl.textContent = `Incorecto!
